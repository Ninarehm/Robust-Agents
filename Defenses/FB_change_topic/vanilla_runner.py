...
f = open('./results_'+ args.dataset + '/vanilla_dial.py|--model|DialoGPT-small|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1.txt', "w")

for i in starting:
	subprocess.call(['python', 'vanilla_dial.py','--model',"microsoft/DialoGPT-small",'--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)
