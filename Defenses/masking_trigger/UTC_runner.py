...
parser.add_argument('--classifier',default="perspective")
parser.add_argument('--criteria',default=1)
...
if args.classifier == 'perspective':
	if args.criteria == '2':
		f = open('./results_'+ args.dataset + '/advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|0|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '3':
		f = open('./results_'+ args.dataset + '/advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|1|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '1':
		f = open('./results_'+ args.dataset + '/advanced_dial.py|--model|DialoGPT-small|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1|--starting_conv--mosttoxic'+".txt", "w")


elif args.classifier == 'perspective-safety':
	if args.criteria == '2':
		f = open('./results_'+ args.dataset + '/both_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|0|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '3':
		f = open('./results_'+ args.dataset + '/both_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|1|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '1':
		f = open('./results_'+ args.dataset + '/both_advanced_dial.py|--model|DialoGPT-small|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1|--starting_conv--mosttoxic'+".txt", "w")

elif args.classifier == 'toxic-bert':
	if args.criteria == '2':
		f = open('./results_'+ args.dataset + '/HF_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|0|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '3':
		f = open('./results_'+ args.dataset + '/HF_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|1|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '1':
		f = open('./results_'+ args.dataset + '/HF_advanced_dial.py|--model|DialoGPT-small|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1|--starting_conv--mosttoxic'+".txt", "w")


elif args.classifier == 'safety':
	if args.criteria == '2':
		f = open('./results_'+ args.dataset + '/safety_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|0|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '3':
		f = open('./results_'+ args.dataset + '/safety_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|1|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '1':
		f = open('./results_'+ args.dataset + '/safety_advanced_dial.py|--model|DialoGPT-small|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1|--starting_conv--mosttoxic'+".txt", "w")


elif args.classifier == 'all':
	if args.criteria == '2':
		f = open('./results_'+ args.dataset + '/three_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|0|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '3':
		f = open('./results_'+ args.dataset + '/three_advanced_dial.py|--model|DialoGPT-small|--tox|1|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--min_tox|1|--less_tox|1|--adversarial_step|1|--starting_conv'+".txt", "w")
	elif args.criteria == '1':
		f = open('./results_'+ args.dataset + '/three_advanced_dial.py|--model|DialoGPT-small|--topics|1|--device_type|'+ args.device_type +'|--seed|0|--adversarial_step|1|--starting_conv--mosttoxic'+".txt", "w")


for i in starting:
	if args.classifier == 'perspective':
		if args.criteria == '2':
			subprocess.call(['python', 'advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','0','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '3':
			subprocess.call(['python', 'advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','1','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '1':
			subprocess.call(['python', 'maxtoxic_dial.py','--model',"microsoft/DialoGPT-small",'--topics','1','--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)


	elif args.classifier == 'perspective-safety':
		if args.criteria == '2':
			subprocess.call(['python', 'both_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','0','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '3':
			subprocess.call(['python', 'both_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','1','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '1':
			subprocess.call(['python', 'both_maxtoxic_dial.py','--model',"microsoft/DialoGPT-small",'--topics','1','--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)


	elif args.classifier == 'toxic-bert':
		if args.criteria == '2':
			subprocess.call(['python', 'HF_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','0','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '3':
			subprocess.call(['python', 'HF_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','1','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '1':
			subprocess.call(['python', 'HF_maxtoxic_dial.py','--model',"microsoft/DialoGPT-small",'--topics','1','--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)

	elif args.classifier == 'safety':
		if args.criteria == '2':
			subprocess.call(['python', 'safety_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','0','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '3':
			subprocess.call(['python', 'safety_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','1','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '1':
			subprocess.call(['python', 'safety_maxtoxic_dial.py','--model',"microsoft/DialoGPT-small",'--topics','1','--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)

	elif args.classifier == 'all':
		if args.criteria == '2':
			subprocess.call(['python', 'three_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','0','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '3':
			subprocess.call(['python', 'three_advanced_dial.py','--model',"microsoft/DialoGPT-small",'--tox','1','--topics','1','--device_type',args.device_type,'--seed','0','--min_tox','1','--less_tox','1','--adversarial_step','1','--starting_conv',i],stdout=f)
		elif args.criteria == '1':
			subprocess.call(['python', 'three_maxtoxic_dial.py','--model',"microsoft/DialoGPT-small",'--topics','1','--device_type',args.device_type,'--seed','0','--adversarial_step','1','--starting_conv',i],stdout=f)
